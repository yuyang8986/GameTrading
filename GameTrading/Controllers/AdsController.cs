...
namespace GameTrading.Controllers
{
    public class AdsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AdID,CustomerID,GameID,GameNamePrice,AdCommenceDate,Adexpirydate,BOrSell")] Ad ad)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AdID,CustomerID,GameID,Price,AdCommenceDate,Adexpirydate,BOrSell")] Ad ad)
        {
            if (ModelState.IsValid)
            {
